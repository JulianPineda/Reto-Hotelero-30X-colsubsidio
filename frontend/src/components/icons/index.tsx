/**
 * Small inline icon set for the ribbon's icon+label actions (no icon
 * library dependency — the whole app has none, and this is five simple
 * glyphs). All use `currentColor` so they inherit whatever color the
 * button/text around them already has.
 */
...
export function ExportIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M12 3v12m0 0-4-4m4 4 4-4M5 17v3a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-3"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
